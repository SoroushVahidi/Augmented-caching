...
OUT_DIR = Path("analysis/reviewer_fairness_v2")
...
def main() -> None:
    ...
    for p in ALL_TWELVE_POLICIES:
        ...
        lines.append(
            ...
            f"{checks.get('ROW_COMPLETENESS','-')} | {checks.get('TRAIN_TEST_SEPARATION','-')} | "
