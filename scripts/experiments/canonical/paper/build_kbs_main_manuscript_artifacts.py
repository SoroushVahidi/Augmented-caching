...
EVIDENCE_FILES = {
    "policy_comparison": ANALYSIS / "manuscript_canonical" / "evict_value_wulver_v1_policy_comparison_heavy_r1.csv",
    "policy_comparison_md": ANALYSIS / "manuscript_canonical" / "evict_value_wulver_v1_policy_comparison_heavy_r1.md",
    "dataset_summary": ANALYSIS / "manuscript_canonical" / "evict_value_v1_wulver_dataset_summary_heavy_r1.md",
    "train_model_comparison": ANALYSIS / "manuscript_canonical" / "evict_value_wulver_v1_model_comparison_heavy_r1.csv",
    "train_metrics": ANALYSIS / "manuscript_canonical" / "evict_value_wulver_v1_train_metrics_heavy_r1.json",
    "best_config": ANALYSIS / "manuscript_canonical" / "evict_value_wulver_v1_best_config_heavy_r1.json",
    "trace_manifest": ANALYSIS / "manifests" / "wulver_trace_manifest_full.csv",
