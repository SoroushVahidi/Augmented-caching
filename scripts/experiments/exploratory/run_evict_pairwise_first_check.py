"""
DEPRECATED: This script is superseded by run_evict_value_pairwise_first_check.py.
It is kept for historical reproducibility of early pairwise experiments.
"""
