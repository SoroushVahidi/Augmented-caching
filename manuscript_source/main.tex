...
The overall framework also includes a lightweight, optional fallback layer that can defer to a conservative baseline when recent local behavior appears unsafe; Section~\ref{subsec:implications} and Section~\ref{subsec:limitations} discuss why this remains a design extension rather than a validated empirical contribution in the present study.
