...
\title{Decision-aligned eviction-value prediction for robust learning-augmented caching}
...
\begin{keyword}
learning-augmented caching \sep online paging \sep cache replacement \sep eviction-value prediction \sep robust cache control
\end{keyword}
\end{frontmatter}
