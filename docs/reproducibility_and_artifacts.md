...
**KBS manuscript (canonical `heavy_r1`, builder, tables/figures):** start at `docs/kbs_manuscript_workflow.md` and the one-page checklist [`../historical/CANONICAL_KBS_SUBMISSION.md`](../historical/CANONICAL_KBS_SUBMISSION.md).
