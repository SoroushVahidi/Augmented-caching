...
> Reviewer note (2026-08-14): this is a scientific working map. The
> reviewer landing page is `docs/reviewer/START_HERE.md`. Common-Model V2
> and the tie-aware oracle are **in the revised manuscript**. Status labels
> below remain the scientific dispositions.
