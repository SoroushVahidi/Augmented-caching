...
## Manuscript schematic (optional)

A high-level control-flow figure (PDF/PNG + LaTeX snippet) lives under `figures/manuscript/` and `reports/manuscript_artifacts/latex_snippets/figure6_guard_wrapper_snippet.tex`, generated by:

```bash
python scripts/paper/build_guard_wrapper_manuscript_figure.py
```

See `reports/manuscript_artifacts/figure6_guard_wrapper_report.md` for scope and limitations.
