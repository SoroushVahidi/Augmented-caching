...
| Continuation-policy causal ablation (C0/C1/C2, frozen protocol) | 21 planned units | `PRODUCTION_RUNNING_LOCAL_TMUX` | Local production campaign is running in tmux session `kbs_continuation_c0_c1_c2_production_resume_20260812` from source SHA `a813617f36822f793b0e48b0ee3e6009d56ee324`, config SHA-256 `7556e120ead3b3e8a8c6d85ef7f800f2e8f1f1cb37800bde57b14d1a194d8670`, with serial thread caps and `--resume --max-wall-hours 8`. Read-only audit observed 8/21 completed units and 24 policy rows; expected final outputs are 21 units, 63 policy rows, 21 label-agreement rows, and 21 pi2-training rows. No scientific result yet; do not mark complete until integrity passes. | `analysis/continuation_policy_causal_ablation_production_v1/`, `models/continuation_policy_causal_ablation_production_v1/` | Running; no outcome yet |
...
3. Monitor the launched continuation-policy C0/C1/C2 production runner locally -- tmux session `kbs_continuation_c0_c1_c2_production_resume_20260812`, source SHA `a813617f36822f793b0e48b0ee3e6009d56ee324`; do not mark complete until the 21-unit integrity manifest passes.
...
- **Continuation-policy mismatch (H5/H6) is unresolved, not disfavored --
  ...
  **zero** of those 9 and worsened in 9 of the 12 overall. This is
  ...
  only 8/21 units had completed at the last read-only audit.
