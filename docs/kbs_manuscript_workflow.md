...
**End-to-end evidence gap (what is missing vs what already helps):** [`archival/reports/manuscript_artifacts/end_to_end_evidence_gap_report.md`](archival/reports/manuscript_artifacts/end_to_end_evidence_gap_report.md).
