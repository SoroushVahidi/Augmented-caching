...
**Checklist hub (scripts + filenames + do-not-cite list):** [`../historical/CANONICAL_KBS_SUBMISSION.md`](../historical/CANONICAL_KBS_SUBMISSION.md). **All `docs/` grouped by topic:** [`README.md`](README.md).
