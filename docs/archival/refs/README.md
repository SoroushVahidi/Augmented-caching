...
**Maintenance:** update `note={Verify...}` fields after exporting authoritative metadata; see [`../reports/manuscript_artifacts/table6_related_work_uncertainties.md`](../reports/manuscript_artifacts/table6_related_work_uncertainties.md).
